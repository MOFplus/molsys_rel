...
class fragmentizer:
    ...
    def read_catalog(self):
        ...
        """
        f = open(self.frag_path + "/fragments.csv", "r")
    ...
    def __call__(self, mol, man = False, plot=False, verbose=False, get_missing=False):
        """
        ...
        vtype = list(map(lambda e: e.split("_")[0], atypes))
        ...
        scan_prio = []
        tmpnames = []
        for fname in list(self.fragments.keys()):
